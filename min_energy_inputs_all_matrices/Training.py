...
def NN(para):
    ...
    model.add(Dense(256, input_shape=(7,), activation=actf,
                    kernel_regularizer=reg, use_bias=True))
    model.add(Dense(128, activation=actf, kernel_regularizer=reg, use_bias=True, kernel_initializer=ki))
...
N = 15000               # maximum number of epochs
